            ...
            <>
              ...
              <div className="overflow-hidden rounded-2xl border border-white/10 bg-mml-navy-card shadow-sm">
                <div className="flex items-center gap-2.5 border-b border-white/10 bg-mml-navy-mid px-4 py-3">
                  <div className="relative flex h-[30px] w-[30px] shrink-0 items-center justify-center rounded-full border border-mml-teal/25 bg-[#0e2540]">
                    <svg width="15" height="15" viewBox="0 0 15 15" fill="none">
                      <circle cx="7.5" cy="5" r="3.8" fill="rgba(255,255,255,.9)" />
                      <circle cx="6.2" cy="4.6" r="1.2" fill="#0b1d35" />
                      <circle cx="8.8" cy="4.6" r="1.2" fill="#0b1d35" />
                      <path d="M5.8 6.5Q7.5 8 9.2 6.5" stroke="#0b1d35" strokeWidth=".9" strokeLinecap="round" fill="none" />
                      <ellipse cx="7.5" cy="12" rx="5" ry="2.5" fill="rgba(255,255,255,.18)" />
                    </svg>
