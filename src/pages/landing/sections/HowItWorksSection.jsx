      ...
      <div className="W">
        <Reveal className="hiw-intro">
          ...
          <p className="section-intro">
            Make My Lesson works in four sequential stages — each one building a different piece of your teaching pack.
            Every stage costs one credit. A complete four-stage teaching pack costs 4 credits. Use all four stages together
            or any stage independently — there are no dependencies, no forced workflow.
          </p>
        </Reveal>
