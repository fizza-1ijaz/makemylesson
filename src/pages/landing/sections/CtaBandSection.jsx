    ...
    <section className="final-cta">
      <div className="W final-cta-inner">
        <Reveal>
          ...
          <Link href="/lesson/stage1" className="btn btn-teal btn-lg final-cta-btn">
          ...
          <p className="final-cta-section-label">Study anywhere. Download the app.</p>
          ...
          <div className="final-cta-qr-wrap">
            {CTA_LINKS.qrImage ? (
              ...
              <div className="final-cta-qr-placeholder" aria-hidden>
                <span className="final-cta-qr-placeholder-text">Add QR image URL in CTA_LINKS.qrImage</span>
              </div>
            )}
          </div>
        </Reveal>
