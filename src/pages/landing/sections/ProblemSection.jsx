      ...
      <div className="W">
        <div className="problem-cols">
          <Reveal className="problem-side">
            ...
            <p>
              The average teacher works 49 hours a week — 10 hours more than their contracted hours. Most of those extra
              hours go to exactly the tasks Make My Lesson handles: writing lesson plans, building slide decks, creating
