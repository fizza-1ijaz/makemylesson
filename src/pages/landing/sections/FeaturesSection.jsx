...
const aiToolCards = [
  {
    ...
    desc: 'Go from curriculum and topic to a full plan with objectives, timing, and differentiation—ready to teach tomorrow.',
  },
  {
    id: 'feature-slide-decks',
    Icon: Presentation,
    title: 'Slide decks',
    desc: 'Auto-built decks with clear flow, discussion prompts, and speaker notes; export to Slides, PowerPoint, or PDF.',
  },
  {
    id: 'feature-assessments',
    Icon: ListChecks,
    title: 'Assessments',
    desc: 'Generate checks, worksheets, and tests with varied question types and instant answer keys for fast grading.',
  },
]
      ...
      <div className="W">
        <Reveal className="feat-ai-tools">
          <div className="section-head feat-ai-tools-intro">
            <Label center>AI Tools</Label>
            <h2 className="feat-ai-h2">Everything you need for one complete lesson</h2>
            <p className="feat-ai-lead sub">
              Pick a focus to jump in—or scroll to explore lesson plans, slides, and assessments in depth.
            </p>
          </div>
