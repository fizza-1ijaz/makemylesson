      ...
      <article className="mx-auto max-w-3xl">
        ...
        <div className="mt-10 space-y-8 text-[14px] leading-relaxed text-white sm:text-[15px]">
          ...
          <section>
            ...
            <h3 className="mb-2 font-sans text-[15px] font-semibold text-white">Step 1: Send an Email Request</h3>
            ...
            <h3 className="mb-2 font-sans text-[15px] font-semibold text-white">Step 2: Use the Subject Line</h3>
            <p className="mb-6 font-medium text-white">Account Deletion Request</p>

            <h3 className="mb-2 font-sans text-[15px] font-semibold text-white">Step 3: Include the Following Information</h3>
          ...
          <section>
            <h2 className="mb-3 font-display text-lg font-normal text-white">Verification Process</h2>
            <ul className="list-disc space-y-2 pl-5 marker:text-mml-teal">
          ...
          <section>
            <h2 className="mb-3 font-display text-lg font-normal text-white">Processing Timeline</h2>
          ...
          <section>
            <h2 className="mb-3 font-display text-lg font-normal text-white">What Data Will Be Deleted</h2>
            <p className="mb-4">Upon successful processing, we will permanently delete:</p>

            <h3 className="mb-2 font-sans text-[15px] font-semibold text-white">1. Account Information</h3>
            ...
            <h3 className="mb-2 font-sans text-[15px] font-semibold text-white">2. Generated &amp; Stored Content</h3>
            <ul className="mb-6 list-disc space-y-2 pl-5 marker:text-mml-teal">
              <li>Lesson plans</li>
              <li>Presentations</li>
            ...
            <h3 className="mb-2 font-sans text-[15px] font-semibold text-white">3. Usage &amp; Analytics Data (Linked to Account)</h3>
            <ul className="mb-6 list-disc space-y-2 pl-5 marker:text-mml-teal">
              <li>Platform usage data linked to your account</li>
              <li>Feature interaction history</li>
            </ul>

            <h3 className="mb-2 font-sans text-[15px] font-semibold text-white">4. Other Identifiers</h3>
            <ul className="list-disc space-y-2 pl-5 marker:text-mml-teal">
          ...
          <section>
            ...
            <h3 className="mb-2 font-sans text-[15px] font-semibold text-white">1. Aggregated / Anonymised Data</h3>
            <ul className="mb-6 list-disc space-y-2 pl-5 marker:text-mml-teal">
            ...
            <h3 className="mb-2 font-sans text-[15px] font-semibold text-white">2. Legal, Security &amp; Compliance Records</h3>
            ...
            <h3 className="mb-2 font-sans text-[15px] font-semibold text-white">3. Subscription &amp; Financial Records</h3>
          ...
          <section>
            <h2 className="mb-3 font-display text-lg font-normal text-white">Important Notes</h2>
            <ul className="list-disc space-y-2 pl-5 marker:text-mml-teal">
          ...
          <section>
            <h2 className="mb-3 font-display text-lg font-normal text-white">Additional Information</h2>
            <p>
          ...
          <section>
            <h2 className="mb-3 font-display text-lg font-normal text-white">Need Help?</h2>
          ...
          <section>
            <h2 className="mb-3 font-display text-lg font-normal text-white">Company Information</h2>
